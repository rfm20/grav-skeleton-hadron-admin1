...
return [
    ...
    'filename' => 'C:/xampp/htdocs/grav/grav-skeleton-hadron+admin1/user/pages/03.examples/04.blog/01.item/item.en.md',
    'modified' => 1754217411,
    'size' => 1832,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: Example Post
visible: false
sitemap:
  changefreq: never
  priority: 0.3
...
hero_image: hero.jpg
hero_classes: \'text-light overlay-dark-gradient hero-large parallax\'',
        'markdown' => '!!! This example post shows how a blog can look in Grav.

===

# Example Post

This post is an example of a blog post in Grav. It demonstrates how a blog can look in Grav and what features it offers.
