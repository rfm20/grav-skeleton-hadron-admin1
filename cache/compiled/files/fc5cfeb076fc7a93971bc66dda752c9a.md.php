...
return [
    ...
    'filename' => 'C:/xampp/htdocs/grav/grav-skeleton-hadron+admin1/user/pages/05.examples/01.default/default.en.md',
    'modified' => 1754217411,
    'size' => 5268,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: Default page
published: true
sitemap:
  changefreq: never
  priority: 0.3
  lastmod: 01-08-2025
date: 01-08-2025',
        'markdown' => '!!! This page shows an example of a **default** page. This is the simplest page type and is used for simple page layouts, with the default components. The following features are included in this example:
!!! 1. Images can be full size or displayed with a custom size.
!!! 2. Images can be captioned.
!!! 3. Images can be aligned left or right.
!!! 4. Images can be enlarged when clicked.
