...
return [
    ...
    'filename' => 'C:/xampp/htdocs/grav/grav-skeleton-hadron+admin1/user/pages/05.examples/01.default/default.de.md',
    'modified' => 1754217411,
    'size' => 5420,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: Standard Seite
published: true
sitemap:
  changefreq: never
  priority: 0.3
  lastmod: 01-08-2025
date: 01-08-2025',
        'markdown' => '!!! Diese Seite zeigt ein Beispiel für eine **Standardseite**. Dies ist der einfachste Seitentyp und wird für einfache Seitenlayouts verwendet, mit den Standardkomponenten. Folgende Funktionen sind in diesem Beispiel enthalten:  
...
![Sky and Mountain](chase-moyer-730496-unsplash.jpg?resize=600,450&classes=caption,caption-left,figure-left "Foto von Chase Moyer auf Unsplash")

Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce molestie iaculis nisl sed interdum. Praesent mi nisl, efficitur in felis vel, molestie sollicitudin eros. Mauris urna quam, euismod nec lacinia non, dignissim eu odio. Donec nisl nibh, facilisis at nisl vitae, porttitor hendrerit libero. Integer vel neque in ante condimentum malesuada. Mauris dictum nunc enim, non tincidunt arcu tincidunt vel. Aliquam gravida, massa id semper tincidunt, tellus sapien accumsan tortor, in placerat arcu justo ac urna. Vestibulum blandit ultrices neque, eget congue tortor vehicula id.

[clearboth]

![Sky and Mountain](chase-moyer-730496-unsplash.jpg?resize=600,450&classes=caption,caption-right,figure-right "Foto von Chase Moyer auf Unsplash")
