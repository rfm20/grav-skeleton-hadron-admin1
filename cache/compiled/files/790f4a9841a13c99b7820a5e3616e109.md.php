...
return [
    ...
    'filename' => 'C:/xampp/htdocs/grav/grav-skeleton-hadron+admin1/user/pages/04.blog/01.item/item.de.md',
    'modified' => 1754217411,
    'size' => 1886,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: Beispiel Beitrag
visible: false
sitemap:
  changefreq: never
  priority: 0.3
...
hero_image: hero.jpg
hero_classes: \'text-light overlay-dark-gradient hero-large parallax\'',
        'markdown' => '!!! Dieser Beispiel Beitrag zeigt, wie ein Blog in Grav aussehen kann.
