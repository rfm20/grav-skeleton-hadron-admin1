...
return [
    ...
    'filename' => 'C:/xampp/htdocs/grav/grav-skeleton-hadron+admin1/user/pages/06.docs/00.intro/item.en.md',
    'modified' => 1754217411,
    'size' => 3806,
    'data' => [
        'header' => [
...
hero_image: hero.webp
hero_classes: \'text-light overlay-dark parallax\'',
        'markdown' => '!!! This page contains a brief introduction to Hadron and describes the main features and possibilities.
