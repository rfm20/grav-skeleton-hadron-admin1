...
return [
    ...
    'checksum' => '5a005976ce6afde6116078e6691b12b5',
    'files' => [
        'user/config' => [
            'backups' => [
            ...
            'plugins/dotenv' => [
                'file' => 'user/config/plugins/dotenv.yaml',
                'modified' => 1754217411
            ],
            'plugins/email' => [
            ...
            'plugins/email-sendgrid' => [
                'file' => 'user/config/plugins/email-sendgrid.yaml',
                'modified' => 1754217411
            ],
            ...
            'plugins/healthcheck' => [
                'file' => 'user/config/plugins/healthcheck.yaml',
                'modified' => 1754217411
            ],
            'plugins/login' => [
            ...
            'plugins/shortcode-gallery-plusplus' => [
                'file' => 'user/config/plugins/shortcode-gallery-plusplus.yaml',
                'modified' => 1754217411
            ],
            'plugins/sitemap' => [
            ...
            'plugins/translate-date' => [
                'file' => 'user/config/plugins/translate-date.yaml',
                'modified' => 1754217411
            ],
            'plugins/umami-analytics' => [
                'file' => 'user/config/plugins/umami-analytics.yaml',
                'modified' => 1754217411
            ],
            'plugins/youtube' => [
            ...
            'themes/local' => [
                'file' => 'user/config/themes/local.yaml',
                'modified' => 1754217411
            ],
            'versions' => [
        ...
        'user/plugins' => [
            ...
            'plugins/shortcode-media' => [
                'file' => 'user/plugins/shortcode-media/shortcode-media.yaml',
                'modified' => 1754217419
            ],
            'plugins/quick-tray-links' => [
            ...
            'plugins/zooming' => [
                'file' => 'user/plugins/zooming/zooming.yaml',
                'modified' => 1754217422
            ],
            'plugins/email-sendgrid' => [
                'file' => 'user/plugins/email-sendgrid/email-sendgrid.yaml',
                'modified' => 1754217414
            ],
            ...
            'plugins/translate-date' => [
                'file' => 'user/plugins/translate-date/translate-date.yaml',
                'modified' => 1754217421
            ],
            'plugins/email' => [
            ...
            'plugins/dotenv' => [
                'file' => 'user/plugins/dotenv/dotenv.yaml',
                'modified' => 1754217414
            ],
            'plugins/auto-date' => [
            ...
            'plugins/umami-analytics' => [
                'file' => 'user/plugins/umami-analytics/umami-analytics.yaml',
                'modified' => 1754217422
            ],
            'plugins/page-toc' => [
                'file' => 'user/plugins/page-toc/page-toc.yaml',
                'modified' => 1754217417
            ],
            ...
            'plugins/healthcheck' => [
                'file' => 'user/plugins/healthcheck/healthcheck.yaml',
                'modified' => 1754217416
            ],
            'plugins/form' => [
        ...
        'user/themes' => [
            'themes/local' => [
                'file' => 'user/themes/local/local.yaml',
                'modified' => 1754217411
            ],
            'themes/quark' => [
            ...
            'themes/hadron' => [
                'file' => 'user/themes/hadron/hadron.yaml',
                'modified' => 1754217416
            ]
        ]
    ],
    'data' => [
        'themes' => [
            ...
            'hadron' => [
                ...
                'invert_logo' => true,
                'favicon' => [
                    'user/themes/hadron/images/hadron-favicon.svg' => [
                        'name' => 'hadron-favicon.svg',
                        'full_path' => 'hadron-favicon.svg',
                        'type' => 'image/svg+xml',
                        'size' => 566,
                        'path' => 'user/themes/hadron/images/hadron-favicon.svg'
                    ]
                ],
                'custom_logo' => [
                    'user/themes/hadron/images/logo/hadron-logo.svg' => [
                        'name' => 'hadron-logo.svg',
                        'full_path' => 'hadron-logo.svg',
                        'type' => 'image/svg+xml',
                        'size' => 3076,
                        'path' => 'user/themes/hadron/images/logo/hadron-logo.svg'
                    ]
                ],
                'custom_logo_mobile' => [
                    'user/themes/hadron/images/logo/hadron-logo.svg' => [
        ...
        'plugins' => [
            ...
            'zooming' => [
                ...
                'zIndex' => 998,
                'initTemplate' => 'plugin://zooming/js/zooming.init.js'
            ],
            'email-sendgrid' => [
                'enabled' => true,
                'transport' => 'api',
            ...
            'feed' => [
                ...
                'limit' => 10,
                'title' => 'Hadron',
                'description' => 'Hadron is a Grav theme and skeleton that serves as a template for beginners to create websites and webshops, but can also be used by professionals as a foundation for complex projects.',
                'length' => 500,
            ...
            'sitemap' => [
                ...
                'ignores' => [
                    ...
                    1 => '/ignore-this-route',
                    2 => '/ignore-children-of-this-route/.*'
                ],
                'whitelist' => NULL,
                'xsl_transform' => true,
                'html_support' => false,
            ...
            'shortcode-core' => [
                ...
                'custom_shortcodes' => '/user/themes/local/shortcodes',
                'fontawesome' => [
                    'load' => true,
...
node_modules',
        ...
        'site' => [
            ...
            'metadata' => [
                'description' => 'Hadron ist ein Grav Theme und Skeleton, das für Einsteiger als Vorlage für Website uns Webshops dient, aber auch für Profis als Basis für komplexe Projekte genutzt werden kann.',
                'keywords' => 'grav, theme, skeleton, hadron, website, webshop',
                'enabled' => true,
                'format' => 'short',
                'size' => 300,
                'delimiter' => '==='
        ...
        'groups' => [
            'website' => [
                ...
                'enabled' => true,
                'readableName' => 'Website Login',
                'description' => 'Kann sich an der Website anmelden'
            ],
            'admin' => [
                'access' => [
                    'admin' => [
                ...
                'enabled' => true,
                'readableName' => 'Admin Login',
                'description' => 'Kann sich am Admin Panel anmelden'
            ],
            'statistics' => [
                'access' => [
                    'admin' => [
            ...
            'editor' => [
                ...
                'readableName' => 'Content Editor',
                'description' => 'Kann bestehende Seiten bearbeiten',
                'enabled' => true
            ],
            'pages' => [
                'access' => [
                ...
                'readableName' => 'Pages Manager',
                'description' => 'Kann Seiten verwalten',
                'enabled' => true
            ],
            'maintainer' => [
                'access' => [
                ...
                'description' => 'Kann die Seite warten'
            ],
            'manager' => [
                'access' => [
                    'admin' => [
                ...
                'readableName' => 'Site Manager',
                'enabled' => true,
                'description' => 'Kann Seiten- & Systemeinstellungen verwalten'
            ],
            'themes' => [
                'access' => [
                    'admin' => [
                ...
                'readableName' => 'Theme Manager',
                'enabled' => true,
                'description' => 'Kann Themes verwalten'
            ],
            'plugins' => [
                'access' => [
                    'admin' => [
                ...
                'readableName' => 'Plugin Manager',
                'enabled' => true,
                'description' => 'Kann Plugins verwalten'
            ],
            'accounts' => [
                'access' => [
                    'admin' => [
                ...
                'readableName' => 'Account Manager',
                'enabled' => true,
                'description' => 'Kann Benutzerkonten verwalten'
            ]
        ],
        'scheduler' => [
            'status' => [
