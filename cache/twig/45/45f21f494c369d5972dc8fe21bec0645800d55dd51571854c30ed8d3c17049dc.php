...
class __TwigTemplate_9d2235245856b1a3ac1a16872a748da3791a31ba02c3b5d381205f087ab7da25 extends \Twig\Template
{
...
<p>The theme itself is useful, however, it may be easier to create a website with the Hadron Skeleton. The Hadron theme is included in the <a href=\"https://github.com/Crabston/grav-skeleton-hadron\">Hadron Skeleton</a>, which includes a complete website. This includes: examples of content, configurations, themes, and plugins.</p>
<h3>1. GPM Installation (recommended)</h3>
<p><em>This method is currently not supported as the theme is not yet available in the GPM. Please use another method.</em></p>
<p>The easiest way to install this theme is through the <a href=\"http://learn.getgrav.org/advanced/grav-gpm\">Grav Package Manager (GPM)</a> in your system terminal (also called command line). To do this, type the following command in the root directory of your Grav installation:</p>
...
<p><em>This method is currently not supported as the theme is not yet available in the GPM. Please use another method.</em></p>
<p>If you are using the <a href=\"https://github.com/getgrav/grav-plugin-admin\">Admin Plugin</a>, you can install the theme directly through the Admin Plugin. Go to the <code>Themes</code> section and click on <code>Add</code> and search for <code>hadron</code>. Select the theme and click on <code>Install</code>.</p>
...
<h3>4. Manual Installation (not recommended)</h3>
<p>To manually install the theme, simply download the zip version of this repository and unpack it under <code>/your/site/grav/user/themes</code>. Then rename the folder to <code>hadron</code>. The theme files can be found on <a href=\"https://github.com/Crabston/grav-theme-hadron\">GitHub</a> or on <a href=\"http://getgrav.org/downloads/themes\">GetGrav.org</a>.</p>
...
<p>The theme is now activated and should be visible on your site. You can now customize the theme settings and design the page to your liking. Learn more about the <a href=\"/grav/grav-skeleton-hadron+admin1/en/hadron/theme/options\">Theme Options</a>.</p>";
    }
