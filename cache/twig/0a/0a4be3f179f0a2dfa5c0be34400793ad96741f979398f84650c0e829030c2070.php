...
class __TwigTemplate_ccb66052ec4c82a2f8d5b34d1599a8cffb0e28da0bbf259458022db8d15e8c64 extends \Twig\Template
{
...
<h2>Variants to customize the theme</h2>
<p>In Grav, there are multiple ways to customize a theme (see <a href=\"https://learn.getgrav.org/17/themes/customization\">Grav Docs</a> for further info). Basically, there are two ways to customize the Hadron theme:</p>
<ol>
...
<p>The easiest way to customize the Hadron theme is to use the <a href=\"https://github.com/Crabston/grav-skeleton-hadron\">Hadron Skeleton</a>. The Hadron Skeleton is a pre-configured Grav package that includes the Hadron theme and some demo content.</p>
...
<h2>other ways</h2>
<p>If you rather not use the Hadron Skeleton, you can also create a child theme manually. For more information, see the <a href=\"https://learn.getgrav.org/17/themes/customization#theme-inheritance\">Grav Docs</a>. This is useful if you already habe a Grav installation and want to add the Hadron theme to it. But if you want to create a new website with Grav + Hadron, the skeleton might be the better choice.</p>
<p>Nevertheless, it can be useful to take over some of the Local Theme to facilitate the customizations. You can find the code in the <a href=\"https://github.com/Crabston/grav-skeleton-hadron/tree/main/themes/local\">Hadron Skeleton on GitHub under <code>themes/local</code></a>.</p>";
    }
