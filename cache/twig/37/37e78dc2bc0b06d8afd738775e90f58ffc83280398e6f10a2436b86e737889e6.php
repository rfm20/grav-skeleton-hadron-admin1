...
class __TwigTemplate_3fd646721519f9c4d867d76118aa9d496f38cde004c1cef75e9520ca647dfd3e extends \Twig\Template
{
    ...
    {
        // line 1
        $context["url"] = ((array_key_exists("url", $context)) ? (_twig_default_filter(($context["url"] ?? null), (($this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->rtrimFilter(($context["base_url"] ?? null), "/") . "/") . twig_trim_filter($this->getAttribute(($context["config"] ?? null), "get", [0 => "plugins.tntsearch.query_route", 1 => "s"], "method"), "/")))) : ((($this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->rtrimFilter(($context["base_url"] ?? null), "/") . "/") . twig_trim_filter($this->getAttribute(($context["config"] ?? null), "get", [0 => "plugins.tntsearch.query_route", 1 => "s"], "method"), "/"))));
        // line 2
...
<form role=\"form\" class=\"tntsearch-form\" action=\"";
        // line 12
        echo twig_escape_filter($this->env, ($context["nojs_action"] ?? null), "html", null, true);
        echo "\" method=\"get\">
    ";
        // line 13
    ...
    ";
        ...
        ";
            // line 27
            echo $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->translate($this->env, "PLUGIN_TNTSEARCH.POWERED_BY", "<a href='https://github.com/trilbymedia/grav-plugin-tntsearch' target='_blank'>TNTSearch</a>");
            echo "
    </p>
    ";
        }
