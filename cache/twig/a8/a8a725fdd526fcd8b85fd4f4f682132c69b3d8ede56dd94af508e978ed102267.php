...
/* @quark/partials/base.html.twig */
class __TwigTemplate_b5a39468a53ed13dd090b0b34dff1d2e6d6e054dcdea8563245181e026797f8f extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $_trait_0 = $this->loadTemplate("blocks/base.html.twig", "@quark/partials/base.html.twig", 4);
        // line 4
...
";
    ...
    ";
        // line 14
        $this->loadTemplate("partials/metadata.html.twig", "@quark/partials/base.html.twig", 14)->display($context);
        // line 15
        echo "
...
";
    ...
    public function block_header($context, array $blocks = [])
    {
        ...
        echo "\">
                <nav class=\"navbar\">
                    <section class=\"navbar-section logo\">
                        ";
        // line 47
        $this->loadTemplate("partials/logo.html.twig", "@quark/partials/base.html.twig", 47)->display($context);
        // line 48
        echo "                    </section>
        ...
        if (($this->getAttribute($this->getAttribute($this->getAttribute(($context["config"] ?? null), "plugins", []), "login", []), "enabled", []) && $this->getAttribute($this->getAttribute(($context["grav"] ?? null), "user", []), "username", []))) {
            ...
            try {
                $__internal_f607aeef2c31a95a7bf963452dff024ffaeb6aafbe4603f9ca3bec57be8633f4 =                 $this->loadTemplate("partials/login-status.html.twig", "@quark/partials/base.html.twig", 58);
            } catch (LoaderError $e) {
    ...
    public function block_header_navigation($context, array $blocks = [])
    {
        // line 53
        echo "                            ";
        $this->loadTemplate("partials/navigation.html.twig", "@quark/partials/base.html.twig", 53)->display($context);
        // line 54
        echo "                        ";
    }
    ...
    public function block_messages($context, array $blocks = [])
    {
        ...
        try {
            $__internal_62824350bc4502ee19dbc2e99fc6bdd3bd90e7d8dd6e72f42c35efd048542144 =             $this->loadTemplate("partials/messages.html.twig", "@quark/partials/base.html.twig", 81);
        } catch (LoaderError $e) {
            // ignore missing template
        }
    ...
    public function block_footer($context, array $blocks = [])
    {
        // line 92
        echo "        ";
        $this->loadTemplate("partials/footer.html.twig", "@quark/partials/base.html.twig", 92)->display($context);
        // line 93
        echo "    ";
    }
    ...
    public function block_mobile($context, array $blocks = [])
    {
        ...
        <div class=\"overlay\" id=\"overlay\">
            <div class=\"mobile-logo\">
                ";
        // line 99
        $this->loadTemplate("partials/logo.html.twig", "@quark/partials/base.html.twig", 99)->display(twig_array_merge($context, ["mobile" => true]));
        // line 100
        echo "            </div>
            <nav class=\"overlay-menu\">
                ";
        // line 102
        $this->loadTemplate("partials/navigation.html.twig", "@quark/partials/base.html.twig", 102)->display(twig_array_merge($context, ["tree" => true]));
        // line 103
        echo "            </nav>
        </div>
    </div>
