...
class __TwigTemplate_0d5d1f13587f830dbb8d451a9b3aaab9d17967c18f05cd8b28d1910f6bc4f610 extends \Twig\Template
{
...
<p>Um mit dem Setup zu beginnen, musst du das Skeleton zuerst installieren. Siehe dazu die <a href=\"/grav/grav-skeleton-hadron+admin1/en/hadron/skeleton/installation\">Installationsanleitung zum Hadron Skeleton</a>.</p>
</div>
<h2 id=\"1-formale-aenderungen\"><a href=\"#1-formale-aenderungen\" class=\"toc-anchor before\" data-anchor-icon=\"#\" aria-label=\"Anchor\"></a>1. Formale Änderungen</h2>
...
<h2 id=\"3-installation\"><a href=\"#3-installation\" class=\"toc-anchor before\" data-anchor-icon=\"#\" aria-label=\"Anchor\"></a>3. Installation</h2>
...
<h2 id=\"4-weitere-anpassungen\"><a href=\"#4-weitere-anpassungen\" class=\"toc-anchor before\" data-anchor-icon=\"#\" aria-label=\"Anchor\"></a>4. weitere Anpassungen</h2>
...
<h2 id=\"5-optimierungen\"><a href=\"#5-optimierungen\" class=\"toc-anchor before\" data-anchor-icon=\"#\" aria-label=\"Anchor\"></a>5. Optimierungen</h2>
...
<h3 id=\"5-1-sendgrid-api-key\"><a href=\"#5-1-sendgrid-api-key\" class=\"toc-anchor before\" data-anchor-icon=\"#\" aria-label=\"Anchor\"></a>5.1 SendGrid API Key</h3>
<p><a href=\"https://sendgrid.com\" target=\"_blank\" rel=\"nofollow noopener noreferrer\" class=\"external-link no-image\">SendGrid</a> ist ein E-Mail Service Provider, der es ermöglicht, E-Mails zu versenden. Dafür muss ein Account bei SendGrid vorhanden sein.</p>
<p>Wenn eine Grundkonfiguration besteht, kann einfach über <a href=\"https://app.sendgrid.com/settings/api_keys\" target=\"_blank\" rel=\"nofollow noopener noreferrer\" class=\"external-link no-image\">app.sendgrid.com/settings/api_keys</a> ein neuer API Key mit der Berechtigung «Mail Send &gt; Mail Send: Yes» erstellt werden und in der Konfiguration eingetragen werden oder via Doppler verwaltet werden.</p>
<h3 id=\"5-2-umami-website-id\"><a href=\"#5-2-umami-website-id\" class=\"toc-anchor before\" data-anchor-icon=\"#\" aria-label=\"Anchor\"></a>5.2 Umami Website Id</h3>
<p><a href=\"https://github.com/Crabston/grav-plugin-umami-analytics\" target=\"_blank\" rel=\"nofollow noopener noreferrer\" class=\"external-link no-image\">Umami</a> ist ein Open Source Analytics Tool, das es ermöglicht, detaillierte Statistiken über die Website zu sammeln. Dafür muss ein Account bei <a href=\"https://umami.is/\" target=\"_blank\" rel=\"nofollow noopener noreferrer\" class=\"external-link no-image\">Umami</a> vorhanden sein.</p>
...
<h3 id=\"5-3-doppler-konfiguration\"><a href=\"#5-3-doppler-konfiguration\" class=\"toc-anchor before\" data-anchor-icon=\"#\" aria-label=\"Anchor\"></a>5.3 Doppler Konfiguration</h3>
<p><a href=\"https://www.doppler.com\" target=\"_blank\" rel=\"nofollow noopener noreferrer\" class=\"external-link no-image\">Doppler</a> ist ein Secrets Manager, der es ermöglicht, API Keys und andere sensible Daten sicher zu speichern und zu verwalten. Dafür muss ein Account bei Doppler vorhanden sein.</p>
