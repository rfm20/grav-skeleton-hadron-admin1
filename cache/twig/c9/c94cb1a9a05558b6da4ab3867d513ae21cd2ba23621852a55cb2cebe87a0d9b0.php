...
/* @Page:C:/xampp/htdocs/grav/grav-skeleton-hadron+admin1/user/pages/03.examples/01.default */
class __TwigTemplate_86c34fae6d0a3ec937a4c9d398217298f4a592376d52961ddd6f940aae55a655 extends \Twig\Template
{
...
<p>This page shows an example of a <strong>default</strong> page. This is the simplest page type and is used for simple page layouts, with the default components. The following features are included in this example:</p>
<ol>
<li>Images can be full size or displayed with a custom size.</li>
<li>Images can be captioned.</li>
<li>Images can be aligned left or right.</li>
<li>Images can be enlarged when clicked.</li>
</ol>
</div>
<p><img src=\"/grav/grav-skeleton-hadron%20admin1/examples/default/chase-moyer-730496-unsplash.jpg?lightbox=1\" alt=\"Sky and Mountain\"></p>
...
<p>Nunc eget odio luctus, vestibulum ligula non, interdum massa. Ut scelerisque tincidunt justo feugiat sagittis. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Fusce vulputate elementum eros vitae efficitur. Sed volutpat in diam nec ornare. Sed consequat, arcu lacinia vehicula sodales, velit erat condimentum ante, vel vestibulum libero quam ac orci. Sed placerat, nunc vitae euismod convallis, orci justo accumsan odio, non vehicula neque eros id libero. Donec in sagittis risus.</p>";
    ...
    {
        return "@Page:C:/xampp/htdocs/grav/grav-skeleton-hadron+admin1/user/pages/03.examples/01.default";
    }
    ...
    {
        return new Source("", "@Page:C:/xampp/htdocs/grav/grav-skeleton-hadron+admin1/user/pages/03.examples/01.default", "");
    }
}
