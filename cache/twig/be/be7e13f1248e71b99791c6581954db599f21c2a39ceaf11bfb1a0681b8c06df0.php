...
class __TwigTemplate_a1d31e7a7f68cc5f8bbe74470128d7c280ffa973fe05a357e7857af7c4393499 extends \Twig\Template
{
...
<h3>1.1 Copy repository (recommended)</h3>
...
<h3>1.3 Clone repository directly (not recommended)</h3>
...
<p>You can also use our <a href=\"https://github.com/Crabston/grav\">modified Grav Core</a> with additional features:</p>
<pre><code class=\"language-bash\">cd /your/site/
...
<p>To download the Skeleton with dependencies, go to the <a href=\"https://github.com/Crabston/grav-demo/releases\">Releases page</a> and download the latest version. You can then extract the file into the root directory of your server.</p>
<h3>2.2 manually (not recommended)</h3>
...
<div class=\"notices blue\">
<p>This Skeleton is a modular component for Grav that requires <a href=\"http://github.com/getgrav/grav\">Grav</a>, multiple plugins, and themes to function. If you download this Skeleton as part of a pre-packaged bundle from <a href=\"http://getgrav.org/downloads/skeletons#extras\">GetGrav.org</a> or <a href=\"https://github.com/Crabston/grav-demo/releases\">GitHub Releases</a>, you should have everything you need to get started.</p>
</div>
<h2>Next steps</h2>
<p>After installing the Skeleton, you can start developing/ editing your site.</p>";
    }
